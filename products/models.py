...
class Product(models.Model):
    ...
    illustrator = models.CharField(max_length=254,
    ...
    rating = models.DecimalField(max_digits=6, decimal_places=2,
                                 null=True, blank=True)
    isbn = models.DecimalField(max_digits=12, decimal_places=0,
                               null=True, blank=True)
    language = models.CharField(max_length=254,
                                null=True, blank=True)
    num_pages = models.DecimalField(max_digits=4, decimal_places=0,
                                    null=True, blank=True)
